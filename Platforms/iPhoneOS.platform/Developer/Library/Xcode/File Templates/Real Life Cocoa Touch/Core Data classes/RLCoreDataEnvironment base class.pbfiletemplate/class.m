...
static «FILEBASENAMEASIDENTIFIER» *__sharedCoreDataEnvironment = nil;
...
{
    if (self = [super init]) {
        self.managedObjectContextHash = [NSMutableDictionary dictionaryWithCapacity:«FILEBASENAMEASIDENTIFIER»ContextIdentifierCount];
        self.dispatchQueueHash = [NSMutableDictionary dictionaryWithCapacity:«FILEBASENAMEASIDENTIFIER»ContextIdentifierCount];
...
- (dispatch_queue_t)dispatchQueueForContextIdentifier:(«FILEBASENAMEASIDENTIFIER»ContextIdentifier)contextIdentifier;
{
    ...
    if (contextIdentifier == «FILEBASENAMEASIDENTIFIER»ContextIdentifierMainThreadContext)
...
{
    return [self managedObjectContextForContextIdentifier:«FILEBASENAMEASIDENTIFIER»ContextIdentifierMainThreadContext];
}
...
- (void)setIsTestEnvironment:(BOOL)newValue
{
    ...
    if (_isTestEnvironment) {
        ...
        self.modelBundle = [NSBundle bundleWithIdentifier:@"com.«ORGANIZATIONNAME».UnitTest"];
    } else {
        self.storeType = nil;
