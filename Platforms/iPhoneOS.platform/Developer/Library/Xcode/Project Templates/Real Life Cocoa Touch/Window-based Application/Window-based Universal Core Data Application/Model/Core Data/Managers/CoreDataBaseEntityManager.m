/******************************************************************************
 *  \file CoreDataBaseEntityManager.m
...
#import "CoreDataBaseEntityManager.h"


@implementation CoreDataBaseEntityManager
...
static CoreDataBaseEntityManager *__sharedCoreDataBaseEntityManager = nil;
...
+ (CoreDataBaseEntityManager *)singleton;
{
    @synchronized(self)
    {
        if (__sharedCoreDataBaseEntityManager == nil)
        {
            __sharedCoreDataBaseEntityManager = [[self alloc] init];
        }
    }
    return __sharedCoreDataBaseEntityManager;
}
...
+ (id)allocWithZone:(NSZone *)zone
{
    @synchronized(self)
    {
        if (__sharedCoreDataBaseEntityManager == nil)
        {
            __sharedCoreDataBaseEntityManager = [super allocWithZone:zone];
            return __sharedCoreDataBaseEntityManager;
        }
    }
    return nil;
